...
* Those recommending the imposition of privatization on the herders would divide the meadow in half and assign half the meadow to one herder and half to the other herder -> then playing a game against nature - > presuming herders are motivated by profit incentive. If the location of lush growth changes dramatically from year to year, dividing the commons may impoverish both herders and 